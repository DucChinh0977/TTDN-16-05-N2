...
class DuAn(models.Model):
    ...
    nguoi_phu_trach_id = fields.Many2one('quan_ly_nhan_su.nhan_vien', string='Người Phụ Trách', ondelete='set null')

    nhan_vien_ids = fields.Many2many('quan_ly_nhan_su.nhan_vien', 'du_an_nhan_vien_rel', 'du_an_id', 'nhan_vien_id', string='Nhân Viên Tham Gia')
